...
public class CustomDFSClient extends DFSClient {
    private final Connection connection;

    public CustomDFSClient(URI nameNodeUri, Configuration conf, FileSystem.Statistics stats, Connection connection) throws IOException {
